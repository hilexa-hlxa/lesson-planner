...
import { GraduationCap, FileText, ChevronRight, User, LayoutGrid, Gamepad2, LogOut } from "lucide-react";
import api from "../api";
    ...
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#020617] text-slate-900 dark:text-white font-sans pt-[120px]">
      ...
      <main className="max-w-6xl mx-auto px-10 py-20 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <Link
            to="/dashboard"
            className="group relative p-12 bg-white dark:bg-zinc-900 rounded-[50px] border-[4px] border-black dark:border-white shadow-[12px_12px_0px_0px_rgba(37,99,235,1)] hover:shadow-none hover:translate-x-2 hover:translate-y-2 transition-all"
          >
          ...
          <div className="relative p-12 bg-slate-100 dark:bg-zinc-950 rounded-[50px] border-[4px] border-dashed border-slate-300 dark:border-zinc-800 opacity-60">
            ...
            <p className="text-left text-slate-400 font-bold leading-relaxed mb-8 max-w-[280px]">{hubT.studentDesc}</p>
          </div>
        </div>
      </main>
