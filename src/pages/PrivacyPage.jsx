...
const T = {
  RU: {
    ...
    s3: "Обработка ИИ",
    s3body: "Когда вы генерируете план урока, тест или итог урока, текст запроса отправляется в Groq API для обработки. Не вставляйте в поля персональные данные учеников (полные ФИО, медицинские сведения, домашние адреса) — для тестов и отчётов достаточно имени или инициалов.",
    s4: "Данные учеников",
  ...
  KZ: {
    ...
    s3: "ЖИ өңдеуі",
    s3body: "Сіз сабақ жоспарын, тест немесе қорытынды жасағанда сұраныс мәтіні өңдеу үшін Groq API-ге жіберіледі. Өрістерге оқушылардың дербес деректерін (толық аты-жөні, медициналық мәліметтер, үй мекенжайы) енгізбеңіз — тесттер мен есептер үшін аты немесе аты-жөнінің әріптері жеткілікті.",
    s4: "Оқушы деректері",
  ...
  EN: {
    ...
    s3: "AI processing",
    s3body: "When you generate a lesson plan, quiz or summary, the prompt text is sent to the Groq API for processing. Do not paste student personal data (full legal names, medical details, home addresses) into the fields — a first name or initials is enough for quizzes and reports.",
    s4: "Student data",
